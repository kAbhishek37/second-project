...
@Component(service = Servlet.class, property = { "sling.servlet.methods=" + "GET",
		"sling.servlet.paths=" + "/secondprojectdemo/bin/api/content/v3", "sling.servlet.extensions=" + "json" })
public class ExposeJsonV3 extends SlingSafeMethodsServlet {

	private static final long serialVersionUID = 1L;
	private static final Logger LOG = LoggerFactory.getLogger(ExposeJsonV3.class);
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		String nodePath = "/content/secondprojectdemo/en/" + pageName;
